        ...
        <tr class="dia_linha">
            <td>
                <div class="dia_card dia_selecionado">
                    <div class="acoes">
                        <h1>1</h1>
                        <div class="btn btn_circular" href="#">
...
<div class="overlay">
    <div class="popup">
        ...
        <div class="tab-content active" id="horarios">
            ...
            <br>
            <div id="acoes">
                <div class="btn btn_circular btn_grande">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
        ...
        <div class="tab-content" id="observacao">
            ...
            <div id="acoes">
                <div class="btn btn_circular btn_grande" onclick="abrirFormObs()">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z" />
                    </svg>
                </div>
            ...
            <div id="observacoes">
                <div class="observacao">
                    ...
                    <div class="acoes">
                        <div class="btn btn-quadrado" onclick="excluirPonto()">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                ...
                card_day += `<td>
                    <div class="dia_card ${d.class} ${data_render === data_atual ? "dia_atual" : ""}">
                        <div class="acoes">
                            ...
                            <div class="btn btn_circular" onclick="abrirPopup('horarios', '${formattedDate}')">
            ...
            pontosDoDiaEscolhido.forEach((ponto, idx) => {
                ...
                htmlPonto += `
                    <div class="registro_ponto">
                        ...
                        <div class="evento_hora">
                            ${ponto.horario}
                            <div class="btn btn-quadrado" onclick="excluirPonto(${ponto.id_ponto})">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                    <path d="M135.2 17.7L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-7.2-14.3C307.4 6.8 296.3 0 284.2 0L163.8 0c-12.1 0-23.2 6.8-28.6 17.7zM416 128L32 128 53.2 467c1.6 25.3 22.6 45 47.9 45l245.8 0c25.3 0 46.3-19.7 47.9-45L416 128z" />
                                </svg>
                            </div>
                ...
                if (ponto.id_observacao) {
                    ...
                    <div class="observacao">
                        ...
                        <div class="acoes">
                            <div class="btn btn-quadrado" onclick="excluirObservacao(${ponto.id_observacao})">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                    <path d="M135.2 17.7L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-7.2-14.3C307.4 6.8 296.3 0 284.2 0L163.8 0c-12.1 0-23.2 6.8-28.6 17.7zM416 128L32 128 53.2 467c1.6 25.3 22.6 45 47.9 45l245.8 0c25.3 0 46.3-19.7 47.9-45L416 128z" />
                                </svg>
                            </div>
